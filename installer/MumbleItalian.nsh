...
LangString MUMBLE_TERMINATE_DBUS ${LANG_ITALIAN} "Il DBus utilizzato da Mumble è attualmente in uso. Terminarlo in modo da poter installare l'aggiornamento?"
...
LangString MUMBLE_NO_XP ${LANG_ITALIAN} "Mumble funziona solo su Windows XP SP2 o superiore. Un sistema operativo vecchio è stato riconosciuto e Mumble potrebbe non funzionare, vuoi continuare l'installazione?"
LangString MUMBLE_START ${LANG_ITALIAN} "Avvia Mumble"

; For the start menu
LangString MUMBLE_README_LNK ${LANG_ITALIAN} "Leggimi di Mumble"
LangString MUMBLE_LICENSE_LNK ${LANG_ITALIAN} "Licenza di Mumble"
LangString MUMBLE_QT_LNK ${LANG_ITALIAN} "Licenza di Qt"
LangString MUMBLE_SPEEX_LNK ${LANG_ITALIAN} "Licenza di Speex"
LangString MUMBLE_UNINSTALL_LNK ${LANG_ITALIAN} "Disinstalla Mumble"
LangString MUMBLE_COMPAT_LNK ${LANG_ITALIAN} "Mumble (Modalità retrocompatibile)"

; Install types
LangString INSTALL_FULL ${LANG_ITALIAN} "Completa"
LangString INSTALL_CLIENT ${LANG_ITALIAN} "Solo Client"
LangString INSTALL_SERVER ${LANG_ITALIAN} "Solo Server"

; Install sections
LangString MUMBLE_SEC_MUMBLE ${LANG_ITALIAN} "Mumble (Client)"
LangString MUMBLE_SEC_MUMBLE11X ${LANG_ITALIAN} "Mumble (Client modalità retrocompatibile)"
LangString MUMBLE_SEC_MURMUR ${LANG_ITALIAN} "Murmur (server)"
LangString MUMBLE_SEC_BONJOUR ${LANG_ITALIAN} "Bonjour per Windows"
LangString DESC_SectionMumble ${LANG_ITALIAN} "Client di Mumble, quello di cui hai bisogno per connetterti ai server"
LangString DESC_SectionMumble11X ${LANG_ITALIAN} "Client di Mumble, quello di cui hai bisogno per connetterti ai server vecchi"
...
LangString DESC_SectionBonjour ${LANG_ITALIAN} "Bonjour abilita la possibilità di trovare un server Murmur all'interno della tua rete LAN. Questa funzione scaricherà e installerà Bonjour"
...
LangString DESC_SectionUninstAll ${LANG_ITALIAN} "Disinstallazione completa di Mumble e Murmur, comprese le impostazioni e i dati"
